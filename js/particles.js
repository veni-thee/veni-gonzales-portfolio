(function () {
  function createParticleField(container) {
    var canvas = container.querySelector(".sf-canvas-bg");
    if (!canvas || typeof TweenLite === "undefined") {
      return;
    }

    var ctx = canvas.getContext("2d");
    var width, height, points, target;
  ...
  function init() {
    document.querySelectorAll(".sf-particle-bg").forEach(function (container) {
